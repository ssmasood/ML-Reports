...
## METHODS ################################################################
    ...
    def plotBoundary(self,X,Y):
        ...
        x2b = (-1/self.theta[2])*(self.theta[1]*x1b + self.theta[0]) # TODO find x2 values as a function of x1's values
    ...
    def train(self, X, Y, initStep=1.0, stopTol=1e-4, stopEpochs=5000, plot=None):
        ...
        while not done:
            ...
            if epoch > stopEpochs or (epoch > 1 and np.abs(Jnll[-1] - Jnll[-2]) < stopTol):
